...
forgotPasswordRouter
    .post('/forgot', jsonBodyParser, (req, res, next) => {
...
forgotPasswordRouter
    .get('/reset/:temppass', (req, res, next) => {
    ...
    .post('/reset_password', jsonBodyParser, (req, res, next) => {
...
forgotPasswordRouter
    .post('/confirm_creds', jsonBodyParser, (req, res, next) => {
